...
angular.module "myApp.directives"
  .directive 'itemControlHeader', ->
    restrict: 'E'
    scope: {}
    template: """
      <div class="item-control-header" ng-class="{'item-control-header--show': $ctrl.isShow}">
          <span>
    ...
    bindToController: 
      posts: "="
      pageType: "="
    controller: ItemControlHeader
    controllerAs: "$ctrl"

class ItemControlHeader
  ...
  subscribe: ->
    ...
    @$scope.$on 'multiSelect::rangeSelect', (event, args) => 
    ...
    @$rootScope.$on 'SearchBox::random', (event, args) => @close()
...
ItemControlHeader.$inject = ['$scope', '$rootScope', 'ItemSelectionService']